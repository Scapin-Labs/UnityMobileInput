...
namespace Mopsicus.Plugins {
 ...
 /// <summary>
 /// Event when text end changing in InputField, added by jhedenius
 /// </summary>
 ...
 /// </summary>
 /// <param name="text">text</param>
 private void OnSelectionChange (int selectionPos) {
 Debug.Log("Setting native cyrsor pos " + selectionPos);
 _inputObject.caretPosition = selectionPos;
 }
 ...
 } else if (msg.Equals (TEXT_SELECTION_CHANGE)) {
